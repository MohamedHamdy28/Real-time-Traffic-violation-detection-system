...
def get_settings(file=USER_CONFIG_DIR / 'settings.yaml', version='0.0.1'):
    ...
    """
    from ultralytics_detector.yolo.utils.checks import check_version
    ...
    defaults = {
        'datasets_dir': str('datasets'),  # default datasets directory.
        'weights_dir': str('weights'),  # default weights directory.
        'runs_dir': str('runs'),  # default runs directory.

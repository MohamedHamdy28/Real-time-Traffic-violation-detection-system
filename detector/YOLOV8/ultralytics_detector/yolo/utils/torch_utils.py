...
from ultralytics_detector.yolo.utils import DEFAULT_CONFIG_DICT, DEFAULT_CONFIG_KEYS, LOGGER
from ultralytics_detector.yolo.utils.checks import git_describe
